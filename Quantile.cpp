...
double Quantile::UQuantile(const double &a){
...
double Quantile::TQuantile(const double &a, const int &v1)
{
...
double Quantile::XiQUnatile(const double &a, const double &v1)
{
    double u = UQuantile(a);
    return v1 * pow(1.0 - 2.0 / (9.0 * v1) + u * sqrt(2.0 / (9.0 * v1)), 3.0);
}

double Quantile::FQuantile(const double &a, const double &v1, const double &v2)
{
